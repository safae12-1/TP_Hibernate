...
public class TestLigneCommandeProduit {
    ...
    public static void main(String[] args) {
        ...
        LigneCommandeProduitPK lpk = new LigneCommandeProduitPK(p.getId(), c.getId()); //knnsfto commande o produit
        LigneCommandeProduitPK lpk2 = new LigneCommandeProduitPK(p2.getId(), c.getId());
        
        LigneCommandeProduit lp = new LigneCommandeProduit(lpk, 10);//knsfto (commande+produit) m3a quantite
